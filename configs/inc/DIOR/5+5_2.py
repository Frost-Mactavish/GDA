...
dataset_type = "DIORDataset15"
data_root = f"/data/my_code/dataset/DIOR/{task}"

ori_config = f"configs/inc/DIOR/{task}_{step - 1}.py"
ori_checkpoint = f"log/DIOR/{task}/STEP{step - 1}/best_model.pth"

work_dir = f"log/DIOR/{task}/STEP{step}"
