...
python tools/train.py configs/base/VOC/5.py
python tools/train.py configs/base/VOC/10.py
python tools/train.py configs/base/VOC/15.py
python tools/train.py configs/base/VOC/19.py