        ...
        dataset=dict(
            ...
            datasets=[
                dict(
                    ...
                    data_root='/data/my_code/dataset/DIOR',
                    ann_file=
                    '/data/my_code/dataset/DIOR/ImageSets/Main/trainval.txt',
                    data_prefix=dict(
                        sub_data_root=
                        '/data/my_code/dataset/DIOR/Annotations'
                    ),
                    filter_cfg=dict(
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/data/my_code/dataset/DIOR',
        ann_file=
        '/data/my_code/dataset/DIOR/ImageSets/Main/test.txt',
        data_prefix=dict(
            sub_data_root=
            '/data/my_code/dataset/DIOR/Annotations'),
        test_mode=True,
...
launcher = 'pytorch'
work_dir = '/home/Newdisk/luowenlong/Projects/ERD/work_dirs/faster-rcnn_r50_fpn/base19-no-pretrained-1000x600'
