...
default_scope = "mmdet"
custom_imports = dict(
    imports=["mmdet.engine.hooks.checkloss_hook"],
...
custom_hooks = [
    ...
    dict(
        type="SaveBestResultHook",
        key_indicator="pascal_voc/mAP",
        save_file="best_result.txt",
    ),
]
default_hooks = dict(
...
model = dict(
    ...
    pseudo_label_setting=dict(is_use=True, alpha=1.0),
...
train_cfg = dict(
    type="GPR", max_epochs=6, val_begin=1, val_interval=1, lamda=0.6, is_use=True
)
